...
export const person = defineType({
  ...
  fields: [
    defineField({
      ...
      title: "Name",
      type: "string",
      validation: (Rule) => Rule.required().error("Add the persons name before publishing."),
    }),
    defineField({
      name: "initials",
      title: "Initials",
      ...
      validation: (Rule) => Rule.required().error("Add the initials for the placeholder avatar."),
    }),
    defineField({
      name: "role",
      title: "Role",
      ...
      validation: (Rule) => Rule.required().error("Add the person's role before publishing."),
    }),
    defineField({
      name: "keyPerson",
      title: "Key Person",
