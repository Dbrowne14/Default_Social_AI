...
const Page = () => {
  return (
    <div>
      <header className="pt-50 pb-15 border-b border-line">
        <div className="container-custom">
          <div className="eyebrow mb-9">
            Insights
          </div>
          <div className="grid grid-cols-1 md:grid-cols-[1.4fr_1fr] gap-20 md:gap-10 items-end">
            ...
            <div>
              <p className="lede">
                Essays, teardowns and quiet experiments — written by our
                practice leads. Long-form by default, edited by humans,
