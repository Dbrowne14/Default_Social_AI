      ...
      {services.map((service) => {
        return (
          <a
            ...
            className={`py-2 px-3.5 rounded-[999px] border text-[11px] tracking-widest uppercase  transition-colors duration-150 ease-in-out hover:text-accent hover:border-accent ${isActive === service.linkName ? "text-accent border-accent" : "text-cream-2 border-line"}`}
