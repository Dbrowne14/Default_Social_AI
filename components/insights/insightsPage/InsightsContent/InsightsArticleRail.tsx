...
const InsightsArticleRail = ({article, section, setSection}:{article:blogPostProps|undefined, section:string, setSection: React.Dispatch<React.SetStateAction<string>>}) => {
  return (
                    ...
                    return (
                      <li key={post.kicker}>
                        <a
                          ...
                          <span className={`flex size-6 items-center justify-center rounded-full font-mono text-[10px] tracking-[0.06em] transition-colors duration-150
                            ${selectedTitle
                          ...
                          <span className="flex items-center gap-3 min-w-0">
                            <span className={`truncate font-mono text-[11px] tracking-[0.12em] uppercase ${
                            selectedTitle
                                ? "text-accent-2"
                            ...
                            <span
                              className={`h-px flex-1 ${selectedTitle
