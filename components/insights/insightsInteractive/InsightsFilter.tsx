...
const InsightsFilter = ({
  ...
  return (
    <aside className="sticky top-nav py-4 [background:color-mix(in_oklch,var(--ink)_90%,transparent)] backdrop-blur-lg z-30 border-b border-line">
      <div className="container-thin">
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-[clamp(10px,1vw,11px)] tracking-[0.12em] uppercase text-muted mr-2 ">
