...
>
  <article
    className="flex cursor-pointer flex-col gap-4.5 border-t border-line pt-6 transition-transform duration-200 ease-in-out group-hover:-translate-y-0.5"
    data-cat="seo"
  >
    <div className="relative aspect-4/3 overflow-hidden rounded-[14px] border border-line">
      {image ? (
        ...
        <div className="absolute inset-0 [background:radial-gradient(circle_at_30%_40%,color-mix(in_oklch,var(--accent)_22%,var(--ink-3)),transparent_60%),repeating-linear-gradient(135deg,var(--ink-2)_0_12px,var(--ink-3)_12px_24px)]">
    ...
    <p className="text-[15px] leading-normal text-cream-2">
      {excerpt}
    </p>

    <span className="mt-auto pt-3 font-dmSans text-[11px] font-semibold uppercase tracking-[0.16em] text-accent">
      Read article →
    </span>
  </article>
</Link>
