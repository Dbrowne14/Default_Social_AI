...
export default function Button({
  ...
  const classes = `text-[clamp(9px,1.2vw,12px)] inline-flex items-center gap-2 px-4 py-2.5 rounded-full font-dmSans uppercase transition-all duration-150 ease-in-out hover:-translate-y-px tracking-widest
    ${variants[variant]}`;
