...
const ContactForm = () => {
  return (
      <section className="border-t border-line bg-ink" id="contact" data-screen-label="Contact">
          ...
          <form className="flex flex-col gap-4.5">
            <div className="grid grid-cols-1 xs520:grid-cols-2 gap-2.5">
              <div className="flex flex-col gap-1.5">
                <label className="font-mono text-[10px] tracking-[0.14em] uppercase text-muted">Name</label>
                <input className="form-field" type="text" placeholder="First &amp; last" />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="font-mono text-[10px] tracking-[0.14em] uppercase text-muted">Company</label>
                <input className="form-field" type="text" placeholder="Brand or org" />
              </div>
            </div>
            <div className="grid grid-cols-1 xs520:grid-cols-2 gap-2.5">
              <div className="flex flex-col gap-1.5">
                <label className="font-mono text-[10px] tracking-[0.14em] uppercase text-muted">Work email</label>
                <input className="form-field" type="email" placeholder="you@company.com" />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="font-mono text-[10px] tracking-[0.14em] uppercase text-muted">Type of enquiry</label>
            ...
            <div className="flex flex-col gap-1.5">
              <label className="font-mono text-[10px] tracking-[0.14em] uppercase text-muted">What are you trying to make happen?</label>
              <textarea
                rows={5}
